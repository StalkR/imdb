	...
	for _, tt := range []struct {
		...
		},
		{
			...
			want: Title{
				...
				AKA:           []string{"3-Iron", "3-iron", "Bin jib", "Bin-Jip - Der Schattenmann", "Bin-Jip - Leere Häuser", "Bin-jip", "Bin-jip - tomme huse", "Bosh Evler", "Boş ev", "Casa Vazia", "El espíritu de la pasión", "Empty Houses", "Ferro 3", "Ferro 3 - La casa vuota", "Hierro 3", "Hierro-3", "Järn 3:an", "Järntrean", "Khanehaye Khali", "Lehargish B'Bayit", "Locataires", "Lopakodó lelkek", "Menaj in trei", "Provalnik", "Pusty dom", "Rautakolmonen", "Tomme hus", "Tusti namai", "Utsusemi", "Ολομόναχοι μαζί", "Порожній будинок", "Пустой дом", "Стик Nо 3", "うつせみ", "空屋情人"},
			},
		},
	} {
